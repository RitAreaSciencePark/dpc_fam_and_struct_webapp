...
CMD ["gunicorn", "dpc_fam_and_struct_webapp.wsgi:application", "--bind=0.0.0.0:8000", "--workers=2", "--timeout=120", "--graceful-timeout=30", "--worker-tmp-dir=/tmp", "--no-control-socket", "--access-logfile=-", "--error-logfile=-"]
